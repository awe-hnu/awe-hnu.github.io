---
title: "Maschinen wie ich?"
subtitle: "Eine kurze Einführung zur Künstlichen Intelligenz (KI)"
...
![](images/scifi-star-wars.jpeg){.absolute top=330 left=60 height="180" .fragment}
...
![](images/hwk.png){.absolute .fragment top=100 left=60 height="450" }
...
Laut ChatGPT hat Generative KI das Potenzial auf unterschiedlichen Ebenen zu verändern.
...
:::medium
[Steigerung der Produktivität^[Im Schnitt 35% erhöhte Produktivität]]{.fragment .fade-in fragment-index=1} [bei verbesserter Qualität]{.fragment .fade-in fragment-index=2} [und höherer Arbeitszufriedenheit.]{.fragment .fade-in fragment-index=3}
:::

:::{.smaller .fragment fragment-index=3}
...
[lernen Sie die Interaktion mit Generativer KI^[Empfehlung: [Learn Prompting](https://learnprompting.org/)], ]{.fragment .fade-in-then-semi-out} 
[ finden sie lohnende Use-Cases für die HWK]{.fragment .fade-in-then-semi-out} 
...
# Danke für Ihr Aufmerksamkeit {background-color=black .vertical-center}

...
# Power dynamics {background-color="#cdd6d5"}
...
# Sources of power  {background-color="#cdd6d5"}
...
## Final remarks {.html-hidden .unlisted .discussion-slide background-color="#cdd6d5"}

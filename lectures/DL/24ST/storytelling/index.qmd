...
# Storytelling and leadership {.vertical-center background-color="#cdd6d5"}
...
# Exercise {.vertical-center background-color="#cdd6d5"}
...
# Structure {.vertical-center background-color="#cdd6d5"}
...
# Q&A {.html-hidden .unlisted .vertical-center background-color="#cdd6d5"}

...
:::html-hidden
:::medium
[Achievement-oriented, ]{.fragment .highlight-current-blue}
[work facilitation/ supportive,]{.fragment .highlight-current-blue}
[interaction facilitation,]{.fragment .highlight-current-blue}
[group oriented decision process,]{.fragment .highlight-current-blue}
[representation and networking,]{.fragment .highlight-current-blue}
[value-based]{.fragment .highlight-current-blue}
[& shared leadership]{.fragment .highlight-current-blue}
:::
:::
...
Shared leadership
: shares responsibility for leadershop to increase unit cohesiveness (functions bes in an interdependent environment)
:::

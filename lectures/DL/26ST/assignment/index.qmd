...
[in a **13-minute presentation** ]{.fragment .fade-in-then-semi-out}
...
The **presentation** must take between 10 and 13 minutes (strictly enforced) and is followed by a 10-minute discussion led by an assigned challenger.
:::
...
::: notes
The latticework approach from Unit 1 teaches us that complex situations require multiple mental models. This assignment puts that principle into practice: you take one real leadership situation and show how two different theories illuminate different, complementary aspects of it.
...
When selecting a leader, prioritize those with **well-documented specific situations.** Consider leaders where you can find detailed accounts of particular decisions, crises, or initiatives, not just general career narratives.
:::
...
:::callout-note
#### Rationale for Spontaneity

It forces every student to listen actively to every presentation, ready to take on the role. The challenger acts as a critical thinking partner, not an opponent, deepening the analysis through spontaneous, theory-informed critique. The challenger role is **individually graded** (see grading criteria).

- You **cannot outsource** real-time analytical thinking.
- Every student listens as a **potential challenger,** requires active engagement, not passive attendance.
- The skill being assessed is the ability to **think critically on the spot,** which is a core leadership competence.
:::

:::

## Preparation {.html-hidden}
...
- The presenter communicates confidently, uses visual aids effectively, engages the audience, and stays within time (10–13 min). **(Delivery)**
:::
...
:::notes
It is unlikely that every student will receive a very good grade, i.e. deliver an outstanding performance as indicated by the meaning of grades. Instead, it is to be expected that the grades will spread across the spectrum.
:::

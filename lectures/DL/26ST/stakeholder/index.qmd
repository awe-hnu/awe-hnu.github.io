...
- Social capital theory [45 min]{.smaller}
- [Break]{.highlight}
- Stakeholder identification [45 min]{.smaller}
- Wrap-up [10 min]{.smaller}
:::

# Warm-up {.headline-only}

## The Invisible Three {.discussion-slide}

:::large
The HNU is launching a "Digital Leadership" Master's.
:::

Group in pairs and identify three *"shadow" stakeholders* who are not the students or the dean.
...
## Defining Social Capital {.discussion-slide}
...
:::{.content-visible when-format="revealjs"}
:::notes
Expected elements: networks, relationships, resources, trust.
:::
:::
...
:::medium
Your network of relationships often determines the opportunities available to you.
:::
...
:::fragment
@coleman1988social argues that cohesion, that is to say the **strength of the relationship between actors,** is the source of social capital (*strong ties*). Cohesion ...
:::

:::incremental
- facilitates the creation of social norms, trust and sanctions within networks, which safeguard against opportunistic behavior
- enables coordination and increases willingness to engage in knowledge exchange (*bonding*)
:::

:::fragment
@burt2018structural posits that social capital rather emerges from **opportunities to bridge disconnections** or non-equivalencies separating non-redundant sources of information (i.e., *structural holes*)
:::

:::incremental
- Structural holes (i.e. 'weak ties') provide the opportunity to get access to diverse sets of perspectives, skills, or resources.
- Social capital emerges from structurally favorable positions between different groups (*bridging*)
:::
...
@nahapiet1998social: social capital requires more than "knowing" people (Structural); it requires a "shared vision" (Cognitive). If you don't speak the same language as the Finance Office, your Structural connection is useless.

"Social capital tells us *why* relationships matter. Now let's build tools for systematically identifying and prioritizing stakeholders."
:::
:::
...
According to @adler2002social's conceptual model, the value of social capital is contingent on specific contextual factors rather than universal or fixed, which explains why similar network structures or relationships yield different outcomes in different settings.
:::
...
Leadership in modern organizations extends far beyond formal authority. The following practices support effective leadership:
...
- **Embrace productive politics:** politics functions as "power in action." Skilled leaders engage in organizational politics functionally, using influence techniques to navigate interdependencies and resolve conflicts constructively.
...
- **Invest strategically in social capital:** your network is a critical resource. The value of relationships is context-dependent: sometimes strong, cohesive ties are beneficial; other times, weak ties that bridge structural holes provide greater advantage.
...
Effective leadership requires constant attention to dependencies and relationships: continuously reevaluate your sources of power, nurture your network, and adapt your political strategies to changing contexts. Your effectiveness depends on your ability to exercise influence across organizational boundaries.
...
Not all stakeholders are equally important at any given time. @mitchell1997toward proposed the **stakeholder salience model** based on three attributes: power, legitimacy, urgency.

:::{.content-visible when-format="revealjs"}
::: {.r-stack}

![The stakeholder salience model [@mitchell1997toward]](images/stakeholder-1.svg){.fragment height=420}

![&nbsp;](images/stakeholder-2.svg){.fragment height=420}

![&nbsp;](images/stakeholder-3.svg){.fragment height=420}

![&nbsp;](images/stakeholder.svg){.fragment height=420}
...
![The stakeholder salience model [@mitchell1997toward]](images/stakeholder.svg){#fig-stakeholderSalience}

Power
: the stakeholder's ability to influence the organization (coercive, utilitarian, or normative)

Legitimacy
: The perceived appropriateness of the stakeholder's claim or relationship

Urgency
: The degree to which the stakeholder's claim demands immediate attention (time-sensitivity and criticality)
...
Static stakeholder maps are useful starting points, but they miss the **network dynamics** that often determine outcomes. [Questions to be asked:
]{.fragment}

:::fragment
:::medium
Who connects whom?\
Where are the bridges and bottlenecks?
:::
:::
...
:::incremental
- **Identify potential allies and blockers** using the stakeholder map (i.e, who shares your objectives? Who opposes them? Who is undecided?)
...
:::{.content-visible when-format="revealjs"}
:::notes
Push the board to ask: 
"Why *involve* the works council rather than *collaborate*? What happens if you only *inform* end users?"

...
## Ethical dilemma exercise {.discussion-slide background-color="black"}

Consider the following dilemmas. For each, discuss: What would you do? What ethical principles guide your decision? What stakeholder interests are at stake?

. . .

:::incremental
1. **The data dilemma:** Your company's AI system is significantly more profitable when it uses customer data in ways that technically comply with privacy regulations but that most customers would object to if they understood. Do you continue?
2. **The restructuring:** You need to cut 20% of your workforce to ensure long-term company survival. You can do it quickly (efficient but brutal) or gradually (more humane but creates months of uncertainty and lower productivity). Which do you choose?
3. **The cultural clash:** Your most effective sales strategy in a key emerging market involves gift-giving practices that would be considered corruption in your home country but are standard business practice locally. How do you proceed?
:::

:::notes
There are no "right" answers to these dilemmas — the value is in the reasoning process. Push students to identify which ethical framework they are using (authentic leadership's internalized moral perspective? servant leadership's stewardship? utilitarian calculation?) and how stakeholder analysis (Unit 7) would inform their approach. Each dilemma deliberately combines ethical, cultural, and stakeholder dimensions.
:::
...
Return to adaptive leadership [@heifetz1994leadership] from Unit 3: digital transformation is the quintessential **adaptive challenge** — no established playbook, requiring changed behavior at all levels.
...
:::medium
Which 3–5 models do you find most useful for your own leadership context?
:::
...
:::incremental
- Which models changed how you think about a familiar situation?
- Which models do you find yourself applying outside this course?
- Where do you see the biggest gap in your own latticework — what do you still need to learn?
:::

...
- Paradox & behavioral complexity [50 min]{.smaller}
- [Break]{.highlight}
...
Behavioral theories established a vocabulary of what leaders *do*, but left open the question of *when* to do what. Contingency approaches resolved this by matching leadership behaviors to situational demands. Adaptive leadership takes this one step further: some situations don't just require a different style, they require a fundamentally different role for the leader.
...
This flexibility allows leaders to respond appropriately to complex, changing environments rather than being rigid in their approach. It means drawing on a diverse repertoire of leadership behaviors while maintaining a coherent leadership identity, rather than being inconsistent or unpredictable.
:::
...
Land on: today we formalize the idea that paradox is a condition to be navigated, not a flaw to be resolved. The energy flows directly into Block 1.
:::
:::
:::
...
:::{.content-visible when-format="revealjs"}
## Definitions #1 {.discussion-slide}
...
:::{.content-visible when-format="revealjs"}
## Definitions #2 {.discussion-slide}
...
:::fragment
Increasing social and organizational complexity requires **cognitive complexity** and **behavioral complexity:** to "conceive and perform" [@denison1995paradox, p. 524].
:::
...
2. Behavioral complexity = the ability to *act* on multiple competing demands (i.e., to shift between seemingly contradictory behaviors).
3. This is a *repertoire* of leadership behaviors deployed intentionally, not inconsistency or unpredictability.
...
1. Identify a **paradox** they faced (i.e., two contradictory demands at the same time).
...
The key insight of the CVF is that the different model of organizational effectiveness contain inherent paradoxes (hence "competing values"). The competing values are paradoxes because they represent demands that are simultaneously necessary yet seemingly contradictory. Each pair of opposing values reflects a genuine organizational need, but pursuing one appears to undermine the other.

Effective management requires, thus, balancing these competing demands rather than focusing exclusively on one approach. The framework suggests that successful managers develop competencies across all four quadrants and can flexibly apply different approaches depending on the situation.
...
The competing values are paradoxes because they represent demands that are simultaneously necessary yet seemingly contradictory. Each pair of opposing values reflects a genuine organizational need, but pursuing one appears to undermine the other.
...
Form groups of 2-3. Choose an organization you all know quite well (workplace, university, sports club, startup) and:
...
2. How was it treated (i.e., technically or adaptively)?
...
:::{.content-visible unless-format="revealjs"}
The connection between the CVF and adaptive leadership illustrates why behavioral complexity is so essential. Adaptive challenges are inherently paradoxical as they require simultaneous stability and change, direction and empowerment, urgency and patience. A leader who can only operate in one CVF quadrant will struggle with the contradictory demands of adaptive work.
...
:::{.content-visible when-format="revealjs"}
:::notes
Adaptive challenges are inherently paradoxical as they require simultaneous stability and change, direction and empowerment, urgency and patience.
...
Three frameworks, one challenge:
...
:::{.content-visible when-format="revealjs"}
:::notes
A leader who can use all three frameworks simultaneously is demonstrating behavioral complexity.

The LTEE model showed that development happens at the mediator level. These frameworks *are* mediators (i.e., cognitive tools that translate your traits into effective behavior).
:::
:::
...
:::fragment
So the guiding question becomes *"how do I set the stage for it to happen?"*\
rather than *"how do I make innovation happen?"*
:::
...
Purpose
:   Purpose is who is in a group or why it exists, not what the group does. It reflects a collective identity.

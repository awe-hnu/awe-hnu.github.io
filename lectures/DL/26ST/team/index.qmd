...
# Latticework check-in {.headline-only}

## Opening reflection {.no-headline .vertical-center}

:::medium
Teams as **complex adaptive systems** — emergence, feedback loops, and network effects all apply at the team level.
:::

. . .

A team is more than the sum of its members. Team dynamics *emerge* from interactions, and small changes in trust, communication, or norms can create reinforcing loops — for better or worse.
...
Just as organizations face paradoxes (Unit 3), so do teams. Committed leaders need to be aware of at least four contradictory forces in team work and deal with these paradoxes [@hill2003becoming]:
...
This shifting leadership role connects directly to situational leadership (Unit 3): directive → coaching → supporting → delegating maps onto the stages of team development.
:::
...
# Team leadership exercise {.headline-only}

## Case-based exercise {background-color="black"}

Consider the following scenario:

A newly formed **cross-functional project team** has been tasked with developing a digital customer portal. The team includes members from IT, marketing, customer service, and finance — some co-located, some remote. After three weeks, the team leader observes the following:
...
In small groups, **diagnose** the team's situation and **propose** leadership interventions. Use the concepts from this unit (team development stage, psychological safety, diversity/inclusion, virtual team practices).

:::notes
Expected diagnosis: the team is in Wheelan's Stage 2 (counterdependency & fight), with low psychological safety and unmanaged diversity. The remote members' silence suggests an inclusion problem amplified by distance.

Possible interventions: facilitate the IT-marketing conflict rather than suppress it (normalize storming); create explicit norms for meeting participation (e.g., round-robin input); establish structured one-on-ones with remote members; address the dominant senior member privately; run a brief retrospective to surface unspoken tensions.

Challenge groups to connect their proposals to specific concepts: Which CVF quadrant does each intervention represent? How does the intervention affect psychological safety? What Wheelan stage would the intervention move the team toward?
:::

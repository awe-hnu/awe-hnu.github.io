...
Note the connection to engaging leadership ([Unit 4](../motivation/index.qmd)): *facilitating* (autonomy), *connecting* (relatedness), and *strengthening* (competence) all contribute to psychological safety. A disengaging leader who uses coercive, eroding, or isolating behaviors will systematically destroy it.
:::

...
:::notes
This discussion checks homework completion. Students should be able to articulate that the theory is about leaders adapting their behavior to complement follower abilities and environmental conditions. Encourage them to name at least three of the seven behavior classes before the formal introduction.
:::
...
:::notes
Steer the conversation toward examples such as surveillance software that thwarts autonomy, algorithmic task assignment that erodes competence, and remote work isolation that undermines relatedness. Ask students to connect these to the four disengaging behaviors (coercive, eroding, isolating, demotivating) and propose counter-strategies using the engaging leadership framework.
:::

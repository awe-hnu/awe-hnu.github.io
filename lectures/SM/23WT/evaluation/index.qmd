...
Form small groups of 3 to 4 students, discuss your findings from reading @chakravarthy1986measuring, and create a 8 minutes presentation that answers following questions: 
...
![Four planning hierarchies according to @mintzberg2000rise](images/planningHierarchies-1.svg){#fig-planning}
...
![Four planning hierarchies according to @mintzberg2000rise](images/planningHierarchies.svg){#fig-planning}
:::

## Conventional strategic planning

![Conventional strategic planning according to @mintzberg2000rise](images/planning-1.svg){#fig-planning1}

## Strategic planning as a “numbers game”

![Strategic planning as a “numbers game” according to @mintzberg2000rise](images/planning-2.svg){#fig-planning2}
...
![Capital budgeting as ad hoc control](images/planning-3.svg){#fig-planning3}
...
Form small groups of 3 to 4 students, do a research on one of the frameworks and prepare a short presentation (5 minutes) that summarizes the key-tenets of the framework.
...
- What measurement approaches are discussed in the paper for evaluating information systems strategy?

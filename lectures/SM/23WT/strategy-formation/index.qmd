...
# Good vs. poor strategy {.vertical-center background-color="#0333ff"}
...
Take 15 minutes, craft one slide for each aspect and prepare to present your findings.
...
- **acknowledges the challenges** faced,
- provides an approach to overcome them.
:::
...
What is the kernel of good strategies (i.e., the basic underlying structure)?

Take 10 minutes to derive the key tenets.
...
Form small groups and take 15 minutes to consolidate your answers to my questions on @mintzberg1978patterns. Be prepared to present your findings.
...
# Strategy formation {.vertical-center background-color="#0333ff"}
...
:::html-hidden
:::medium
Crafting strategies that revolve around the interplay of the [environment]{.fragment .highlight-blue}, the [organizational operating system]{.fragment .highlight-blue} (i.e., bureaucracy), and [leadership]{.fragment .highlight-blue}.
:::
:::
...
[**Strategic change:**]{.fragment .fade-in} [responses to environmental change, limited by the bureaucracy and mediated by leadership.]{.fragment .fade-in-then-semi-out}
:::
:::

:::notes
**Strategy** can then be viewed as the set of consistent behaviors by which the organization establishes for a time its place in its environment [@mintzberg1978patterns].
...
![Types of strategies according to @mintzberg1978patterns](images/types.svg){#fig-types}
...
:::fragment
Overall, the dichotomy between formulation (and strategy-maker) and implementation (and subordinates who implement) makes little sense [@mintzberg1978patterns].
:::
:::

:::notes

Following his theoretical and empirical observations, @mintzberg1978patterns conclueds that
...
# Crafting strategy {.vertical-center background-color="#0333ff"}

The following thoughts on strategy formation are based on @henry1987crafting.
...
**The interplay of strategy formulation and implementation**
...
Similar to how skilled craftspeople seamlessly blend thought and action in their craft, organizations should not separate the aspects of 'thinking' and 'doing' in strategy.
...
- Barnett and Salomon discuss the shape of the relationship between CSR and financial performance. What does this concept entail, and what insights does it provide for strategic management?
- How can the findings of this study inform strategic management practices related to CSR within organizations?
- Can you identify any strategic implications for firms seeking to integrate CSR into their core business strategies?
:::

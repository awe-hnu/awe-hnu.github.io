...
# Internal audit {.vertical-center background-color="#0333ff"}
...
:::notes
The internal audit focuses on identifying and evaluating a firm's strengths and weaknesses in the functional areas of business, including management, marketing, finance, accounting, production/operations, research and development (R&D), and management of IT/the digital [@david2016strategic0].
...
:::large
> Strategy eats culture for breakfast. *Peter Drucker, Management consultant, educator and author*
:::
...
Form small groups of 3 to 4 students, discuss what you have learned about the resource-based view (RBV) from reading @peteraf1993cornerstones. Create a brief summary of the key tenets of the RBV (one slide) and derive key implications for strategic management (15 minutes).
...
# Resource-based view {.vertical-center background-color="#0333ff"}
...
# Dynamic capabilities {.vertical-center background-color="#0333ff"}
...
# SWOT framework {.vertical-center background-color="#0333ff"}
...
:::smaller
- Why is understanding strategy formation important in the context of strategic management?
- What are the different patterns or approaches to strategy formation that Mintzberg discusses in the paper? Can you provide examples of organizations that might employ each of these patterns?
...
- Why and how does Mintzberg emphasize the role of informal processes in strategy formation? Can you provide examples from real-world organizations where strategies emerged through informal interactions or learning from experience?
- Why and how cam the strategy-maker as well as contingency planning be risky for organizations, particular in turbulent environments? 
...
- What practical implications can we draw from Mintzberg's insights for organizations' strategic management practices?
:::
...
Diverse Strategy Formation Approaches: Mintzberg highlights that strategy formation is not a one-size-fits-all process. Rather, it involves various approaches and patterns, including entrepreneurial, adaptive, planning, and logical incrementalism. Students can learn that organizations may employ different methods based on their unique circumstances.

Strategic Planning is Just One Approach: Mintzberg challenges the dominant view of strategic planning as the primary approach to strategy. He suggests that planning is just one of many ways organizations formulate strategies. This encourages students to appreciate alternative methods and be open to flexibility in strategic decision-making.

Informal Processes Matter: Mintzberg emphasizes that strategy formation is not limited to formal processes or boardroom decisions. Informal interactions, serendipity, and learning from experience play a significant role. This insight encourages students to recognize the importance of informal networks and learning in strategic management.

Emergence of Strategy: The paper highlights that strategies can emerge over time through experimentation and adaptation. Master's students can understand that strategies are not always premeditated but can evolve in response to changing circumstances and feedback from the external environment.

Managerial Roles: Mintzberg discusses the roles that managers play in strategy formation, including entrepreneurial activities, problem-solving, and networking. Students can gain insights into the multifaceted nature of managerial roles in shaping an organization's strategy.

Challenges of Strategy Implementation: While the paper primarily focuses on strategy formation, it indirectly highlights the challenges of implementing strategies. Students can learn that aligning organizational actions with formulated strategies can be complex and may require ongoing adjustment.

Strategic Management Realities: Mintzberg's research provides a realistic perspective on how strategies are formed in practice. It helps students bridge the gap between theoretical frameworks and the messy reality of strategic management.

Critical Thinking: Reading Mintzberg's work encourages critical thinking and reflection on conventional wisdom in strategic management. Students learn to question and explore alternative perspectives on strategy formulation.

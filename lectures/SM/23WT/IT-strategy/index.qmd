...
::: notes
The three conceptions literature differ in terms of the contextual elements of the IS strategy (process, content, desired impact, and alignment).
:::
...
@earl1993experiences show that organizations need to evolve into a organizational perspective of IS strategy that provides a shared understanding across the organization and efficiently guides IT investment and deployment decisions.
...
|------------|------------|------------|------------|------------|------------|
| Main task      | IS/IT application mapping | Defining business needs      | Detailed IS planning            | Strategic/Competitive advantage        | Linkage to business strategy           |
...
@fig-emergence shows that while at any one time a comprehensive analysis of the business and IS/IT internal and external environments can be carried out to define an intended set of strategies, it is unlikely that all aspects of these strategies will be realized. Changes will occur in both the business and IT environments, and these will cause changes to be made to the IS part of the strategy. Also parts of the intended IS/IT strategy may not to be implemented successfully (i.e. projects fail or underachieve) and hence it has to be revised either in timescale or content. In addition, changes in the business or IT environments may impose constraints or open up new IS opportunities [@peppard2016strategic].
:::
...
@peppard2016strategic suggest following structure and contents for an IS strategy: 
...
:::notes
1. **Purpose of IS strategy**: reasons for new/updated strategy such as key changes in business and IT context since last strategy (an strategy can simply be an update of the previous one)
2. **Summary of business strategy**: the context for IS strategy provided by objectives and critical cuccess factors (CSFs), business model, competitive forces and/or similar analyses, operating model, and resulting issues affecting the IS strategy.
3. **Fields of action**: The arguments for **new opportunities through IS** (to gain advantage) and **critical improvement areas** (to avoid disadvantage) incl. refernce to business strategy and further detailed analysis of competence issues, value chains (external and internal) and performance measures (e.g., related to the balanced score card) to determine the opportunity/problem areas and reasons for investment in them.
...
Some common issues that will probably be addressed in the IS/IT management strategy pointed out by @peppard2016strategic:
...
:::notes
- Using the ‘best’ people available from the business and IS/IT unit (and, when necessary, external advisers) to provide knowledge of the industry, the business, the capabilities IS/IT can deliver and, above all, creative thinking, none of which can be derived from a methodology;
- Gaining the enthusiasm, commitment and involvement of top management;
- Getting a thorough understanding of the internal and external business and IS/IT environments, the business situation, its culture and the imperatives driving the strategy;

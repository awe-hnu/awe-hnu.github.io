...
| Section                    | Content
| -------------------------- | ------------------------------------------------------ | 
| Introduction               | [Problem statement, research gap, research question, approach, contributions]{.fragment}
...
| Discussion                 | [Findings, theoretical and practical contributions, limitations, further research, conclusion]{.fragment}
...
# Background  {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
# Theory {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
# Methods  {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
# Findings  {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
# Discussion  {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
# Conclusion {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
Please read the [hypothetical AoM micro submission "Responses to Transformational Leadership: Are Some Followers Immune?"](https://aom.org/docs/default-source/publishing-with-aom/hypotheticalmicrosubmission.pdf?sfvrsn=da37b89a_2) and reflect on the quality of this submission based on your learings in IS research and this module.

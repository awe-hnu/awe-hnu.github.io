...
# Motivation {.html-hidden .unlisted .vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}

:::large
> Your publications advertise your skills, areas of interest, and expertise. *@recker2021scientific [p. 164]*
:::
...
## Discuss {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg" .unlisted .unnumbered .html-hidden }
...
[Hi]: A researcher with an index of *h* has published *h* papers with at least *h* citations each.
...
# Preparation {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
- Write from the middle out, at least for the first draft. Work through drafting (or listing and then drafting) the background section and theory building, first. Then, draft the rest of the paper and the introduction last [@baird2021writing].
:::
...
:::notes
Additional tips @recker2021scientific shares for collaboration:
...
# Process {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
@baird2021writing [p. 1202] proposes following step-by-step process for writing IS papers
...
@recker2021scientific adds to these points

11. Put it in a drawer, take it out, read again, revise again
12. Send it to a friendly reviewer and (professional) copy editor
13. Submit
...
@baird2021writing [p. 1202] has created a planning workshop for empirical IS papers. I recommend using the worksheet to draft and refine the core message for your master thesis. This should facilitate the work on your extended proposal.
:::
...
## Exercise {background-color="#000" .unlisted .unnumbered .html-hidden}

Read section 4 "Generalized Guidelines for Writing IS Papers" in @baird2021writing [(download here)](assets/Baird_2021_JAIS_Writing-IS- Papers.pdf).

Write down one or two lessons that you think are most relevant to the work on your master's thesis.
...
![Publication process in peer-reviewed outlets](images/review-process-1.svg){height="420"}

![&nbsp;](images/review-process-2.svg){.fragment height="420"}

![&nbsp;](images/review-process-3.svg){.fragment height="420"}

![&nbsp;](images/review-process-4.svg){.fragment height="420"}

![&nbsp;](images/review-process-5.svg){.fragment height="420"}

![&nbsp;](images/review-process-6.svg){.fragment height="420"}

![&nbsp;](images/review-process-7.svg){.fragment height="420"}

![&nbsp;](images/review-process-8.svg){.fragment height="420"}

![&nbsp;](images/review-process.svg){.fragment height="420"}
...
## Confessions {.unlisted .unnumbered .htlm-hidden .vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
# Publication {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
:::html-hidden
:::medium
[(Edited) books, ]{.fragment .fade-in-then-semi-out}
[book chapters, ]{.fragment .fade-in-then-semi-out}
[journal articles, ]{.fragment .fade-in-then-semi-out}
[conference papers, ]{.fragment .fade-in-then-semi-out}
[workshop papers, ]{.fragment .fade-in-then-semi-out}
[technical reports, ]{.fragment .fade-in-then-semi-out}
[and many more]{.fragment .fade-in-then-semi-out}
:::
:::
...
Read following paper draft and reflect on the quality of the submission: [Hypothetical AoM micro submission "Responses to Transformational Leadership: Are Some Followers Immune?"](https://aom.org/docs/default-source/publishing-with-aom/hypotheticalmicrosubmission.pdf?sfvrsn=da37b89a_2)

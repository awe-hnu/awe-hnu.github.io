...
:::html-hidden
:::large
[Motivation, ]{.fragment .fade-in-then-semi-out}
[theory, ]{.fragment .fade-in-then-semi-out} 
[method, ]{.fragment .fade-in-then-semi-out}
[results, ]{.fragment .fade-in-then-semi-out}
[contribution, ]{.fragment .fade-in-then-semi-out}
[and writing]{.fragment .fade-in-then-semi-out}  
:::
:::
...
How does the [hypothetical AoM micro submission "Responses to Transformational Leadership: Are Some Followers Immune?"](https://aom.org/docs/default-source/publishing-with-aom/hypotheticalmicrosubmission.pdf?sfvrsn=da37b89a_2) comply with the criteria of good research and good writing discussed so far?

What recommendations would you give the authors?

# Peer-reviews  {.headline-only background-color="#0333ff"}
...
# Reviewing  {.headline-only background-color="#0333ff"}
...
[identify some strengths,]{.fragment .fade-in-then-semi-out}    
[search for the gem (the ideas),]{.fragment .fade-in-then-semi-out}    
...
## Thesis reviews?  {.unlisted .unnumbered .html-hidden}
...
Reflect the reviews on the [Hypothetical AoM micro submission "Responses to Transformational Leadership: Are Some Followers Immune?"](https://aom.org/docs/default-source/publishing-with-aom/reviewsbymicroeditors.pdf?sfvrsn=f08f1fb4_2) — do they conform to the points outlined hitherto?

Imagine you are part of the author team, which review would have been most helpful? Why?

# Revising  {.headline-only background-color="#0333ff"}
...
:::html-hidden
:::medium
[Develop a revision strategy document, ]{.fragment .fade-in-then-semi-out}
[engage in an intellectual conversation, ]{.fragment .fade-in-then-semi-out}
[and produce concise responses.]{.fragment .fade-in-then-semi-out}
:::
:::

...
- teaching sessions and exercises covering 
  - the __writing process and strategy__ (e.g., planning, summarizing, organizing, referencing),
  - the __structure of an academic paper__ (e.g., outline of the document),
  - the __review process__ (e.g., writing a review, writing a response to the reviewer letter),
...
For the writing and language part, you need to get a copy of following book: [@macgilchrist2014academic](https://www.utb.de/doi/book/10.36198/9783838540870) (approx. 14 EUR as an eBook).
...
| Mo, 23.12.                | __Deadline reflection paper__            |            | -                  |

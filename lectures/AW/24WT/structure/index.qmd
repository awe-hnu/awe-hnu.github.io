...
| Discussion       | [Findings, theoretical and practical contributions, limitations, further research]{.fragment}
...
Have a look at one of the papers you consider to be relevant for your study. Focus on one section and analyze it based on the criteria given here.

Where does it adhere to the recommendations and recipes discussed here, and where does it deviate from them? (Why) does the deviation make sense?

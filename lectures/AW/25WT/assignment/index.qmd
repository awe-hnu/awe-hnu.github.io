...
:::{.incremental}
- The initial **version of the introduction** to your master thesis (20 points; [template](assets/25WT_AW_Introduction_Template.docx))
- A __round-table discussion__ (bonus points)
- The **reflection and revision** of your introduction (70 points; [template](assets/25WT_AW_Reflection-and-Revision_Template.docx))
:::

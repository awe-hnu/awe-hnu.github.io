...
-   How do daily congruence and incongruence in the team-enacted versus individually needed use of agile practices affectdeveloper well-being? [@benlian2025team]
...
-   How canIT support be provided for reducing the problem-solving complexity of monitoring the structural anddynamic complexity of IT architectures in the context of a digital business strategy? [@widjaja2020monitoring]
...
* **Scope:** Appropriately narrow — focuses on two levers affecting one key outcome.
...
### Example #1 [@benlian2025team] {visibility="hidden"}
...
### Example #2 [@strich2021world] {visibility="hidden"}

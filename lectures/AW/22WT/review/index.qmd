...
Read one of the reviews on the [Hypothetical AoM micro submission "Responses to Transformational Leadership: Are Some Followers Immune?"](https://aom.org/docs/default-source/publishing-with-aom/hypotheticalmicrosubmission.pdf?sfvrsn=da37b89a_2) and outline whether it conforms to the points outlined hitherto:

[Micro editor reviews on the AoM micro submission "Responses to Transformational Leadership: Are Some Followers Immune?"](https://aom.org/docs/default-source/publishing-with-aom/reviewsbymicroeditors.pdf?sfvrsn=f08f1fb4_2)

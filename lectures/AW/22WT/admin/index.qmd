...
:::{.incremental}
- Writing process and strategy (e.g., research, planning, summarizing, organizing, referencing).
- Elements of writing (e.g., argument and discussion, cause and effect, style)
- Writing vocabulary and language (e.g., precision, clarity, conciseness)
- Structure of a academic paper (e.g., outline of the document)
- Review process (e.g., writing a review, writing a response to the reviewer letter)
- Ongoing language coaching for own project
:::
...
|:------------------|:------------------------------|:------|:--------|:----------|
|`27/09/2022, 9.45` |Kick-off and topic selection   |Theory |Weeger   |E5.1.08
|`29/09/2022, 9.45` |Process & strategy             |Method |Weeger   |E5.1.08
|`30/09/2022, 9.45` |Structure and story            |-      |Weeger   |E5.1.08
|`05/10/2022, 9.45` |Review & revisions             |-      |Weeger   |A.2.48
|`05/10/2022, 14.00`|Presentation & defense         |Method |Weeger   |A.2.48
...
The grade is based on the evaluation of the __[assignment](../assignment/)__ (portfolio exam), including

:::{.incremental}
- Thesis proposal *(40%)*
- Review of a fellow student's proposal (*20%*)
- Revision of the proposal incl. response letter (*20%*)
- Presentation (defense) of the proposal (*20%*)
:::

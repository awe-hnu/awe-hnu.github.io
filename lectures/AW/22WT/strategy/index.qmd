---
title: "Strategy"  
subtitle: "What to consider when writing an article"
lang: en-US
...
## Discuss! {.vertical-center background-color=blue background-image="...assets/images/bg.jpg" .unlisted .unnumbered .html-hidden}

What do you think, how important are publications to a academic career?

# Opening remarks

![The evolution of academia](images/publish-perish.jpg)
...
# Publication {.vertical-center background-color=blue background-image="...assets/images/bg.jpg"}
...
## Enumerate! {.vertical-center background-color=blue background-image="...assets/images/bg.jpg" .unlisted .unnumbered .html-hidden}
...
Scholars also write entire books ore refereed book chapter in edited books. 
...
## Do! {.vertical-center background-color=blue background-image="...assets/images/bg.jpg" .unlisted .unnumbered .html-hidden}
...
# Preparation {.vertical-center background-color=blue background-image="...assets/images/bg.jpg"}

How to prepare to write a successful paper?

## Read before you write

![Reading is key for getting to know the "voice" of the journal](images/reading.jpg)
...
# Process {.vertical-center background-color=blue background-image="...assets/images/bg.jpg"}
...
7. Send it to a (professional) copy editor
8. Submit
:::

## Publication process

![Publication process in peer-reviewed outlets](images/review-process.svg)
...
## Confessions {.unlisted .unnumbered .htlm-hidden .vertical-center background-color=blue background-image="...assets/images/bg.jpg"}

...
In 2001, German physicist Jan Hendrik Schön appeared to produce a series of breakthrough discoveries in the area of electronics and nanotechnology [^Schoen] and was awarded with a number of outstanding reserach awards (e.g., "breakthroughs of the year" by Science).
...
Consequence: His papers were retracted, his doctoral degree from the Uni Konstanz was revoked, he was fired, and was banned from working in science für eight years.
...
## Exercise {.vertical-center background-color=blue background-image="../assets/images/bg.jpg"}
...
# Ethical issues {.vertical-centerbackground-color=blue}

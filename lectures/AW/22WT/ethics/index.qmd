...
## Exercise {.vertical-center background-color="#0333ff" background-image="../assets/images/bg.jpg"}
...
## Think! {.vertical-center background-color="#0333ff" background-image="../assets/images/bg.jpg" .unlisted .unnumbered .html-hidden}

What are further examples of unacceptable behavior in academic writing? 


# Ethical issues {.vertical-center background-color="#0333ff"}

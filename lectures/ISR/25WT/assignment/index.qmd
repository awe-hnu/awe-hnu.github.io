...
Method paper
: A short individual paper presenting and justifying your research design (following the provided [template](assets/ISR_Method-Paper_Template.docx)). You'll clearly articulate your research problem, objectives, and theoretical foundations (if relevant for your design), then identify and explain all relevant methodological aspects with convincing justification. The design should demonstrate how your approach will yield valid and reliable contributions to IS research. **Important:** The method paper is a standalone assignment where you present and justify a research design for a (hypothetical) study (which can be your thesis). You might be able to realize synergies with *Academic Writing*, but you need not.

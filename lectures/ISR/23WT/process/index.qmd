...
# Research process {.vertical-center background-color="#0333ff"}
...
![A generic research journey (own illustration)](images/process-1.svg){.fragment height="420"}
...
# Role of literature {.vertical-center background-color="#0333ff"}
...
Senior Scholars' List of Premier Journals](https://aisnet.org/page/SeniorScholarListofPremierJournals), or [ABS Academic Journal Quality Guide](https://charteredabs.org/academic-journal-guide-2021/)]{.smaller}
...
- A [theory wiki](http://is.theorizeit.org) with summarized information on theories that are widely used in IS research
- The [AIS World Section on Quantitative, Positivist Research Methods in Information
Systems](http://www.janrecker.com/quantitative-research-in-informationsystems)
- The [AIS World Section on Qualitative Research in Information Systems](http://www.qual.auckland.ac.nz)
- The [AIS World Section on Design Research in Information Systems](http://desrist.org/design-research-in-information-systems)

# Systematic literature review {.vertical-center background-color="#0333ff"}
...
# Research questions {.vertical-center background-color="#0333ff"}
...
- Therefore:      
[Why do people reject new technologies?]{.large}
:::

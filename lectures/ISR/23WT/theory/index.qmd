...
Form small groups, have a look at your notes on @podsakoff2016recommendations and synthesize your answers to the following questions:

- What is a concept?
- Why are clear conceptual definitions essential for scientific progress?
- How can such conceptual definitions be created?

# Concepts {.vertical-center background-color="#0333ff"}
...
Poor concept definitions can result in measurement problems, misinterpretations, and difficulties in replicating studies [@podsakoff2016recommendations].
...
# Theory {.vertical-center background-color="#0333ff"}
...
:::html-hidden
:::large
[Idiographic]{.fragment .strike}, [universal]{.fragment .strike}, [data]{.fragment .strike}, [descriptive]{.fragment .strike}, [hypotheses]{.fragment .strike}, [models]{.fragment .strike}, [design]{.fragment .strike}
:::
:::
...
III Prediction
: The theory says **what is and what will be**. It provides predictions and has testable propositions but does not have well developed
justificatory causal explanations. Example: Moore' Law.
...
# Building blocks {.vertical-center background-color="#0333ff"}
...
:::incremental
- Acts like a “glue” that **connects the theoretical constructs and provides meaning**
and relevance to the relationships between these constructs.
...
# Example {.vertical-center background-color="#0333ff"}
...
:::notes
![The Technology Acceptance Model [@davis1989perceived] ](images/tam.svg){#fig-tra}
:::
...
# Theorizing {.vertical-center background-color="#0333ff"}
...
:::incremental
- Think about being in college. You're in class, and the guy next to you -who is obviously a football player -says an unbelievably dumb thing in class. Why?[^source]
- Initial theory: *Football players are dumb.*
:::

. . .

Theories should be about classes of things, not the thing (more **general**)[^low-level].
...
[^source]: The example draws from @lave1993introduction.

[^low-level]: Theories that are too narrow and specific (i.e., low-level theories) are not very interesting, even if they are correct.

# Homework

Read @hund2021digital and make notes on following questions (takes you at least 1 hour):

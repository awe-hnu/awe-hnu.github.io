...
# What do you see? {.html-hidden .unlisted .vertical-center background-color="#000" background-image="images/galaxy.jpg"}
...
# {.html-hidden .unlisted .vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
# Science {.vertical-center background-color="#0333ff"}
...
# Knowledge {.vertical-center background-color="#0333ff"}
...
- **Interpretivism** is the belief that all knowledge is relative to the knower and can only be understood from the point of view of individuals who are directly involved; truth is socially constructed via multiple interpreations by the subjects of knowledge [@trivedi2021].
:::
...
# Research {.vertical-center background-color="#0333ff"}

## Definition

Research includes in-depth investigation or testing, especially [critical and exhaustive investigation or experimentation]{.fragment .highlight-current-blue}, aimed at [the discovery of new facts]{.fragment .highlight-current-blue} and [their correct interpretation]{.fragment .highlight-current-blue}, [the verification of accepted conclusions, theories, or laws]{.fragment .highlight-current-blue} in light of newly discovered facts, or [the practical application of such conclusions, theories, or laws]{.fragment .highlight-current-blue} [@recker2021research].
...
:::fragment
:::large
[Information gathering]{.fragment .strike} or [transmission of facts]{.fragment .strike}, or [something]{.fragment .strike} to get attention
:::
:::
...
# Body of knowledge {.vertical-center background-color="#0333ff"}

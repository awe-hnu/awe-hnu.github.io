...
::: notes
Teaching runs on Wednesday mornings. The first three weeks are dense with industry inputs and extend into the afternoon. After week 3, the afternoon is deliberately kept free for your own work. Room is available.
...
|:-----------------|:-----------------------------------------------------------------------------------------|-----------------------------------------------|:---------|
| Wed, 07.10.      | *U1: Kick-off*, *Industry Inputs (Ingenics, SITS)* <br />and *U2: Synthesizing Insights* | —                                             | C1       |
| Wed, 14.10.      | *Industry Inputs (MBTI, Wilken, EY)*                                                     | *Review notes from the presentations*         | E7.1.01  |
| Wed, 21.10.      | *U3: Epistemology* and *Industry Inputs (Diehl, Wieland)*                                | —                                             | C1       |

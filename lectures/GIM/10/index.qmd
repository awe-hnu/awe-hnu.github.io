...
- Die __Ertragsmodell__ beschreibt wie das Unternehmen Einnahmen generiert und welche Kosten diesen gegenüberstehen.
:::
...
Richtig ist, dass es Schnittmengen zwischen Geschäftsstrategie, Geschäftsmodell und Geschäftsprozessen gibt. Jedoch stellen diese unterschiedliche Informationsebenen dar, die für unterschiedliche Zwecke nützlich sind. Das Geschäftsmodell kann als eine Schnittstelle zwischen der Unternehmensstrategie und den Geschäftsprozessen sowie der unterstützenden Informationssysteme betrachtet werden. 
...
Insbesondere in einem Umfeld, das sich durch ein hohes Maß an Komplexität und schnellem Wandel kennzeeichnet, sind Unternehmen verstärkt darauf angewiesen, das Potenzial eines Unternehmens (Organisation und Technologie) mit dem Planz zur Realisierung von wirtschaftlichen Werten (Strategie) zu verbinden. Diese Brücke stellt das Geschäftsmodell dar.
...
:::{.incremental}
- __Amazon:__ Webshop sowie B2C und B2B Marketplace mit eigener Logistik (teilweise inkl. last Mile)
...
- __About You:__ Online Fashion Retailer, der sowohl selbst verkauft als auch die Technologie-Plattform und das Fullfillment anbietet
:::

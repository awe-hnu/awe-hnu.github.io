...
Die Kosten einer IT-Lösung sollten über die gesamte Lebensdauer hinweg bestimmt werden wobei die Abschätzung der Nutzeffekte üblicherweise schwieriger ist als die Kostenbestimmung [@mertens2016grundzuge].
...
Durch die erfolgreiche Abstimmung kann IT __Produktivität__ erhöhen und bessere __Entscheidungen__ sowie __neue Produkte und Services__ ermöglichen und sich somit zu einem strategischen Wettbewerbsfaktor entwickeln.
...
:::{.notes}
Um die Nutzenpotentiale zu erreichen, müssen die Informationssysteme so gestaltet und gemanaged sein, dass diese die Prozesse und indirekt die Strategie des Unternehmens möglichst optimal unterstützen ("align").
...
Wesentlich Gründe für Outsourcing sind neben **Kostensenkungen** die **Konzentration auf Kernkompetenzen** und der **Zugang zu fehlendem Know-how**.
...
:::{.incremental}
- **IT als Stabstelle** der Geschäftsleitung: IT agiert als verlängerter Arm der Unternehmensleitung
- **IT als Linienfunktion**: IT agiert mit anderen Funktions- und Geschäftsbereichen auf Augenhöhe
- **Mischformen**: Zentrale Funktionen der IT sind als Stabstelle organisiert, geschäftsspezifische Funktionen den Geschäftsbereichen untergeordnet
:::
...
- Was ist notwendig, damit die beschriebenen Nutzenpotenziale realisiert werden können und unter welchen Voraussetzungen entsehen Wettbewerbsvorteile? Beziehen Sie Ihre Antwort auf @fig-mechanismen.
- In wie weit müsste das Kundenportal mit anderen Systemen integriert werden? Geben Sie Beispiele für Prozess- und Datenintegration und erläüutern Sie jeweils die Integrationsrichtung.

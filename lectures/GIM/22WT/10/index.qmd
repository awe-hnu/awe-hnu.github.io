...
- können den Anwendungslebenszyklus beschreiben,
...
Der Lebenszyklus von betrieblichen Anwendungssystemen überspannt den Zeitraum zwischen der ursprünglichen Idee über die Entwicklung und Einführunms, sowie die Wartung und evtl. Weiterentwicklung bis hin zur Ablösung [@krcmar2015grundlagen].
...
@krcmar2015grundlagen [S. 65-66] beschreibt die Phasen des Lebenszyklus wie folgt: 
...
Der Erfolg einer Anwendungsentwicklung hängt wesentlich davon ab, wie gut die einzelnen Schritte des Projektes geplant, wie gut Probleme vorhergesehen und mögliche Lösungen vorbereitet werden [@krcmar2015grundlagen].
...
Das Wasserfall-Modell kommt in seiner  Reinform in der Praxis üblicherweise nicht vor. Stattedessen werden oft *"*zyklische Phasenmodelle* verwendet, die aus mehreren sich  überlappenden Wasserfall-Modellen bestehen und Rücksprünge in Vorphasen vorsehen [@krcmar2015grundlagen].
:::
...
- Welche Anforderungen würden Sie erfassen? Geben Sie beispiele möglicher Anforderungen.
- Wen würden Sie mit einbinden? Ergänzen Sie Ihre Anforderungsliste um die Anforderer.
- Bewerten Sie die Anforderungen auf Ihrer Liste—sehen Sie Zielkonflikte?
...
In den linearen Phasenmodellen zur Software-Entwicklung (den sogenannten Wasserfallmodellen) ist festgelegt, dass mit einer Phase der Software-Entwicklung erst begonnen werden darf, wenn die vorangehende Phase vollständig abgeschlossen ist und die Ergebnisse freigegeben sind. 

Diskutieren Sie die Vor- und Nachteile eines solchen strikten Vorgehens und dokumentieren Sie diese.
...
- Welche Aktivitäten umfasst die Einführung von Individual- und Standard-Software?
...
- Wie verteilen diese sich in etwa auf den Lebenszyklus?
- Wie unterscheiden diese sich zwischen Individual- und Standardsoftware?

...
::: notes
Im den letzten beiden Kapiteln haben wir uns mit Informationssystemen und Geschäftsprozessen beschäftigt. Informationssysteme werden in Geschäftsprozessen eingesetzt, um sicherzustellen, dass die benötigten Daten in der passenden Form in der richtigen Qualität zum richtigen Zeitpunkt zur Verfügung stehen. In diesem Kapitel schauen wir uns Daten etwas genauer an und beantworten die Frage, wie Daten strukturiert sein müssen, damit diese für das Unternehmen Wert erzeugen.
:::

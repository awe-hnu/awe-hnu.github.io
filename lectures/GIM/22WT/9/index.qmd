...
Sie erinnern sich an Ihre Vorlesung *"*Grundzüge Informationsmanagement*"* und die Bedeutung von effizientem Informationsmanagment mittels integrierter Anwendungssysteme. Deshalb entschließen Sie sich, ein solches System einzuführen. Die Entscheidung fällt auf die Open Source Software [Odooo](https://www.odoo.com).
...
3. Zeigen Sie an einem Beispiel im *Buy & Sell* Prozess den Unterschied zwischen Daten und Information auf.

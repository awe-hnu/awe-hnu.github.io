...
# Übungen ✏️ {background-color=lightgray}

## Daten - Information - Wissen ✏️ {background-color=lightgray}
...
Suchen Sie ein Beispiel für eine Branche, die sich im vergangenen Jahrzehnt wesentlich verändert hat. Diskutieren Sie, ob und wie diese Veränderung durch die Digitalisierung von Informationen ermöglicht wurde.

...
::: {.incremental}
- erläutern, dass IT nur im Zusammenspiel mit komplementären organisatorischen Ressourcen zum strategischen Wettbewerbsvorteil werden kann,
- erklären, unter welchen Umständen IT zum Unternehmenserfolg beiträgt,
...
Ist die Abstimmung erfolgreich, kann IT über die Erhöhung der __Produktivität__ von Prozessen und die Ermöglichung __neuer Produkte und Services__ auf den Unternehmenserfolg wirken.
...
# IT-Business-Alignment {.vertical-center background-color="#0333ff"}

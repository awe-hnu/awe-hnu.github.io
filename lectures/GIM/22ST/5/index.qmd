...
# Logisches Datenmodell {.vertical-center background-color="#0333ff"}
...
# Relationale DBS {.vertical-center background-color="#0333ff"}
...
# Datensystemtypen {.vertical-center background-color="#0333ff"}
...
# Big Data {.vertical-center background-color="#0333ff"}

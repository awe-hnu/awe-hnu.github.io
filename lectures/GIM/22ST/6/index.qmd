...
# Wiederholung: IS {.vertical-center background-color="#0333ff"}
...
# Anwendungssysteme {.vertical-center background-color="#0333ff"}
...
# Beispiele {.vertical-center background-color="#0333ff"}

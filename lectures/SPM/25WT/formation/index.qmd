...
2. Identify the major strategic shifts and classify each as [deliberate]{.link-color}, [emergent]{.link-color}, or 
   [mixed]{.link-color} strategy.
3. Which strategic actions would traditional planning with a 5-year plan likely have overlooked?
4. Identify Netflix's crafting capabilities and decide which of these was most critical to its success.
5. Prepare to present one [concrete example]{.link-color} showing how Netflix’s success resulted from 
   [strategic crafting]{.link-color} rather than traditional long-range planning.
:::
...
2. 2007–2012: Launch streaming (“Watch Now”)
3. 2012: Open Connect CDN launch
3. 2012–onwards: Originals (*House of Cards*, *Orange Is the New Black*), data-driven content strategy
4. 2010–2025: Global rollout (Canada → LatAm → 190+ countries), localized hits (*Money Heist*, *Dark*)  
5. Advanced personalization & recommendations (ongoing throughout)

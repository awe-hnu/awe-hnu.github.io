...
## Reflection {.unlisted .unnumbered .html-hidden .discussion-slide .scrollable}
...
:::incremental
1. Review the summary of Netflix's strategic journey (below) and **classify each major shift** as planned, unplanned, or mixed.
2. For each shift: What would Netflix have **missed** if they had rigidly followed a 5-year plan made in 1997?
3. Identify **concrete capabilities** Netflix demonstrated that enabled them to adapt successfully.
4. Prepare to present **one specific example** showing: "Here's where the plan would have failed, but strategic learning succeeded."
:::

:::fragment
[Summary of Netflix journey]{.h4}

- **1997–2006**: DVD rental by mail + subscription model → profitability by 2003
- **2007**: Launch streaming ("Watch Now")
- **2011**: Qwikster disaster (separating DVD/streaming) → reversed after customer backlash
- **2013**: Original content (*House of Cards*) using data insights
- **2016–2025**: Global expansion, localized hits (*Money Heist*, *Squid Game*)
...
- 1997 plan likely: DVD rental optimization, maybe streaming "someday"
- 1997 plan unlikely: Original content production, global localization, CDN infrastructure
- Key capability: Learning from data (viewing patterns → content decisions)
- Key capability: Willingness to pivot (Qwikster reversal shows learning over ego)

Transition to theory:
What you've just identified is the difference between intended and emergent strategy.
...
:::html-hidden
:::medium
Strategy formation refers to the process of [crafting strategies]{.link-color} that revolve around the interplay of the 
...
## Output — three types of strategy {background-image="images/intended-vs-emergent.jpg" background-color=black}
...
[realized strategies]{.fragment .fade-in} [combine both deliberate and emergent elements]{.fragment .fade-in-then-semi-out}[ ]{.fragment}
:::
:::

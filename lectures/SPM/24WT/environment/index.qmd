...
# Mini Case {.html-hidden .unlisted background-color="#000"}
...
Apply what you have learned about external strategic audits up with an EFE matrix that identifies the key external factors for Anthrophic.  Based on the EFE matrix, propose strategic actions that Anthropic should take to leverage opportunities and mitigate threats. 

...
| ---------- | ----------------------------- | --------------------------------------------------------------- | --------------------------------------- |
| `10.10.24` | **Administrivia & Intro**     | What is a simple approach to strategy?                          | —
...
| `07.11.24` | *Q&A session*[^1]             | Which exercises need to be discussed in class?                  | Exercises
| `12.11.24` | **Capabilities**              | What leads to competitive advantage?                            | @ambrosini2009dynamic (@peteraf1993cornerstones)

...
| `12.12.24` | **Management Control**   | How to effectively evaluate strategic performance?              | @chakravarthy1986measuring             |
| `19.12.24` | **IT Strategy**          | What about IS/IT and strategy?                                  | @chen2010information.                  |
| `09.01.24` | **Case Study**           | tbd                               | tbd                                       |
| `16.01.24` | **Strategy in Action**   | *Guest Speech*                                                  | —                                      |
| `23.01.24` | **Exam Preparation**      | What needs to be discussed or explained again?                  | Questions                              |

...
**Ex-ante limits to competition** refer to barriers that exist *before* a firm establishes a superior position. These limits ensure that costs don't offset the potential benefits of a strategic position. Specifically, they limit competition for a position before any firm has established that position, they prevent the costs of acquiring resources from consuming all future profits, and high uncertainty and costs of developing a new technology may limit how many firms attempt to develop it
...
Together, these limits ensure that firms can acquire resources at costs below their ultimate value (ex-ante) and that tey can maintain their competitive advantage once established (ex-post).

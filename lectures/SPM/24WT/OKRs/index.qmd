...
subtitle: "OKRs — How to measure progress that matters?"
lang: en
...
# Prologue {.headline-only background-color="#0333ff"}
...
# OKR superpowers {.headline-only background-color="#0333ff"}
...
# Critical reflection {.headline-only background-color="#0333ff"}

...
| `16.11.23` | **Ethics and Responsibility**| Does it pay off to be really good?                          | @barnett2012does                       |
| `23.11.23` | **Structure**            | How to match a firm's structure with its strategy?              | @lorenz2023perfect                     |
| `30.11.23` | **Management Control**   | How to effectively evaluate strategic performance?              | @chakravarthy1986measuring             |
| `07.12.23` | **IS Strategy**          | What about IS/IT and strategy?                                  | @chen2010information.                  |
| `14.12.23` | Backlog                  | What how to catch up on the backlog?                            | @mithas2016information                 |
| `CW51`[^CW51] | **Alignment**         | How to align business and IT?                                   | @henderson1999strategic                |
| `11.01.24` | **Case Study**           | Sea Limited: Sustain or Expand?                                 |                                        |
| `18.01.23` | **Strategy in Action**   | *Guest Speech*                                                  | —                                      |
...
<!--
| `07.12.23` | **IS Strategy**          | What about IS/IT and strategy?                                  | @chen2010information, @mithas2016information    |
-->
[^CW51]: No lecture due to consulting workshops, you need to work through **IS Strategy** and **Alignment** (see [here](../IT-strategy/#homework)) on your own.

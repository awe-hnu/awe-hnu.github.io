...
## Opening Quote {.vertical-center .no-headline background-color="#f0f0f0"}
...
[[Objectives]{.highlight}: idealistic, not realistic]{.fragment fragment-index=4}

[+ quantification]{.large .fragment .fade-in-then-semi-out fragment-index=2}   
[[Key Results]{.highlight}: work metric driven; prevent shortcuts]{.fragment fragment-index=5}

[+ progress]{.large .fragment .fade-in-then-semi-out fragment-index=3}    
[[Check-ins]{.highlight}: check progress and ambition level]{.fragment fragment-index=6}
...
:::html-hidden
:::large
[Bold goals]{.fragment .fade-in-then-semi-out}   
...
:::fragment
:::large
Key results are [benchmarks toward the objective]{.highlight}, *the how*
:::
:::
...
:::fragment
:::large
Are you [making progress]{.highlight} and are your key results are challenging enough?
:::
:::
...
Option #4: Stop
: An objective or key result: some goals become irrelevant or impractical. Don’t stubbornly cling to a goal just because you set it. If it no longer serves your larger purpose or the company’s, toss it.
...
[Objectives & key results]{.fragment .large .highlight-current-blue fragment-index=2}   
[Set the priorities and 3-5 objectives per tier,]{.fragment .fade-in fragment-index=3} 
[let employees create 3-5 key results per objective]{.fragment .fade-in fragment-index=4}
:::
:::

:::{.fragment .fade-in fragment-index=6}    
:::{.fragment .semi-fade-out fragment-index=8}    
[Cycles, roles & tools]{.fragment .large .highlight-current-blue fragment-index=7}   
[Usually two cycles: annual (long-term OKRs) and quarterly (short-term OKRs) + OKR shepherd + cloud-based management system]{.fragment .fade-in fragment-index=7}
:::
:::

:::{.fragment .fade-in fragment-index=9}    
:::{.fragment .semi-fade-out fragment-index=11}    
[Walk the talk]{.fragment .large .highlight-current-blue fragment-index=10}   
[Check in weekly or monthly, score & reflect, repeat cycle]{.fragment .fade-in fragment-index=10}
:::
:::

## Step 1: Identify the Objectives {visibility=hidden}
...
::: column
[*Traditional management systems*]{.h4}
...
## Align and Connect {background-color="#f0f0f0"}
...
:::html-hidden
:::large
OKRs are [always measurable.]{.highlight}
:::
:::
...
:::html-hidden
:::large
Balance [committed OKRs]{.highlight} and [stretch OKRs.]{.highlight}
:::
:::
...
:::html-hidden
:::large
OKRs foster CFRs[: [conversations]{.highlight}]{.fragment .fade-in}[, [feedback]{.highlight}]{.fragment .fade-in} [& [recognition]{.highlight}]{.fragment .fade-in}
:::
:::
...
OKRs enable the implementation of a continuous performance management system built on CFRs:
...
# Critical Reflection {.headline-only}

## Opening Quote {.no-headline .vertically-center}
...
4. How do OKRs support @mintzberg1978patterns apporaches/patterns of strategy formation (i.e., entrepreneurial, adaptive, planning, and logical incrementalism)?
...
- Review all [case study tasks](../case-2/).

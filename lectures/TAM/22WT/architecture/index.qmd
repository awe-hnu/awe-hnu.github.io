...
Architecture
- is **design**—conceptual visualization;
- is the attempt to **quantify existing and future capabilities**;
- is a **communication medium** for bringing together the stakeholders who rely on that capability;
- is **complex**—there is more than one type of architecture, these are often symbiotic in nature
- is **a system of systems**, represented by an architecture of architectures
- is **evolutionary**—it changes just a we do;
- is **data**;
- ...
...
To progress further in their digital transformation journeys, companies will require a **new approach to enterprise architecture** that is purpose-built for the digital economy.
...
Examples of capabilities that are required to progress through the digital transformation journey and compete in the marketplace [@lin2022enterprise]:

---
title: "Agility"  
subtitle: "How to shape organizations to compete in the digital age?"
lang: en-US
...
What do you mean by agility if you use the term in a general business context? 
...
## {.html-hidden .unlisted .vertical-center background-color=blue background-image="../assets/bg.jpg"}
...
# Agility through IT {.vertical-center background-color=blue}
...
How do do they impact organizational agility?

# Agile at scale {.vertical-center background-color=blue}
...
- **Different approaches in a multi-team environments** (e.g., different interpretations, old and new side by side)
- **Hierarchical management and organizational boundaries** (e.g., silos kept, old-styled management)
- **Requirements engineering challenges** (e.g., user story creation and estimation, gap between long and short-term planning)
...
## Let's do some research {.html-hidden .unlisted .unnumbered .vertical-center background-color=blue background-image="../assets//bg.jpg"}

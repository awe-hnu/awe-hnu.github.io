...
# Agility through IT {.vertical-center background-color="#0333ff"}
...
# Agile at scale {.vertical-center background-color="#0333ff"}
...
## Let's do some research {.html-hidden .unlisted .unnumbered .vertical-center background-color="#0333ff" background-image="../assets//bg.jpg"}

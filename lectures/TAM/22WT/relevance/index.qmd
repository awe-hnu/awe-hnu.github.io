...
:::{.incremental}
- New management paradigms are necessary to transform corporate IT to the innovation driver
...
- IT infrastructure needs to be decoupled from specific applications 
:::
...
:::{.incremental}
- Standardization, advanced architecture concepts (e.g., service-oriented architectures and virtualization), and enterprise architecture management (EAM) need to be pushed further, also for business processes
...
Specifying the decision right and accountability framework to encourage desireable beavior in the use of IT

...
To cope with the multiple ways, @mintzberg2000rise, e.g., has offered five different perspectives of strategy:
...
The **IS portfolio alignment** focuses on creating and maintaining a set of portfolio components that best execute the organization's business and IS strategy—implement information systems, products, and processes that increase value-added capabilities and lead to positive business impact.

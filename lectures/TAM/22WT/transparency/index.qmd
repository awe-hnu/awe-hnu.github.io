...
Getting data
: Data is distributed in multiple data sources, which were never meant to integrate
...
:::{.notes}
#### Finance view [@tucker2016technology]
...
Try to resolve issues of understanding, bring those back to  the plenum you could not resolve using the interactive resource.

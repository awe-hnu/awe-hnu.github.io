...
# Innovation in the digital age {background-color='#14336a' .vertical-center}
...
# Differences across sectors {background-color='#14336a' .vertical-center}
...
# Diffusion trends  {background-color='#14336a' .vertical-center}
...
# Evaluation of innovation  {background-color='#14336a' .vertical-center}
...
# Data-oriented innovation {background-color='#14336a' .vertical-center}
...
# Q&A {.html-hidden .unlisted .vertical-center background-color="#14336a" background-image="../assets/bg.jpg"}

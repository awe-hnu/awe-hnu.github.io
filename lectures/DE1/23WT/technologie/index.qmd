...
1. Recherchieren Sie diesen Begriff und schreiben Sie die Eigenschaften sowie Vor- und Nachteile von Open Source Software auf.
2. Welche Open Source Software kennen Sie?
3. Recherchieren Sie zur [GNU General Public License V3](https://opensource.org/licenses/GPL-3.0), die beispielsweise für Linux verwendet wird. Erläutern Sie,+ was man mit Open Source Software unter dieser Lizenz (nicht) machen darf.

...
# Motivation {.headline-only background-color="#0333ff"}
...
# Digitalisierung {.headline-only background-color="#0333ff"}
...
# Information {.headline-only background-color="#0333ff"}
...
# Informationsmanagement {.headline-only background-color="#0333ff"}
...
# Wirtschaftsinformatik {.headline-only background-color="#0333ff"}
...
# Übungen ✏️ {.headline-only background-color="#0333ff"}

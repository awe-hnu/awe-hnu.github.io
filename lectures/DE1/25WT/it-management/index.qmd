...
2. Positionieren Sie die Projekte in einem Portfolio wie @fig-portfolio (auf Flipchart/Whiteboard).
...
1. Ordnen Sie die drei Probleme den Wirkrichtungen zu: Welche betreffen *Align* (IT → Strategie)? Welche betreffen *Enable* (Strategie → IT)?

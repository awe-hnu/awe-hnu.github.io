...
Sie erinnern sich an Herrn Weeger und seine Betonung der Bedeutung von effizientem Informationsmanagement mittels integrierter Anwendungssysteme. Deshalb entschließen Sie sich, ein solches System einzuführen. Die Entscheidung fällt auf die Open Source Software [Odooo](https://www.odoo.com).
...
- Erstellen Sie [hier](https://www.odoo.com/de_DE/trial) eine Demo-Datenbank in der Cloud-basierten open-source Software Odoo (kostenlose, 15-Tage Testversion). Wählen Sie zum Start die Apps *Verkauf*, *Rechnungsstellung*, *Buchhaltung*, *Lager* und *Einkauf*. Es ist ausreichend, wenn einer aus Ihrer Gruppe die Datenbank erstellt.
...
Wir buchen den Business-Case gemeinsam. Anschließend arbeiten Sie in Kleingruppen an folgenden Fragestellungen:

In Kapitel 1 haben Sie gelernt, dass (a) **Information** analog zu den anderen **Produktionsfaktoren** gesteuert werden müssen und, dass (b) Information die Steuerung der anderen Produktionsfaktoren unterstützt.

1. Erläutern Sie diese beiden Punkte anhand dieses Business Cases.
2. Wie hilft das Managementsystem Odoo die Ziele des Informationsmanagements zu erreichen?
...
Online-Shopping ist im **digitalen Zeitalter** Standard.

1. Erläutern Sie anhand des Online-Shoppings (a) zwei wesentliche Eigenschaften und (b) zwei wesentliche Konsequenzen des digitalen Zeitalters. 
...
4. Zeigen Sie anhand des Beispiels drei spezifische Ziele des Einsatzes von Informationssystemen.

{{< countdown "35:00" top="0">}}

## Create your App

Bei **Anwendungssystemen** wird zwischen **Standardsoftware** und **Individualsoftware** unterschieden.
...
3. Nennen und erläutern Sie jeweils einen Vor- und Nachteil von Individualsoftware am Beispiel der Office Rental App.

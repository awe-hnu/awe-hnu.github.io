...
Recherchieren Sie im Internet nach konkreten Beispielen für folgende Kategorien von Anwendungssystemen. Beschreiben Sie das System anhand der Funktionen und begründen Sie die Zuordnung.
...
[Hier](assets/bestellungen.xlsx) finden Sie eine Tabellenkalkulationsdatei mit einer Liste sämtlicher Artikel, die Ihr Unternehmen während der letzten drei Monate bei ihren Lieferanten bestellt hat. 

Analysieren Sie die Bestelldaten und beantworten Sie:

- Wer sind unsere 5 wichtigsten Lieferanten? 
- Welche Lieferanten sind am zuverlässigsten?
- Welche 10 Artikel sind am kritischsten?
- Wie können wir unsere Supply Chain verbessern?
...
Ordnen Sie die identifizierten Funktionen den drei Ebenen von CRM-Systemen zu: operativ, kommunikativ und analytisch.

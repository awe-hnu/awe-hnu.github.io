...
:   Mehrere Funktionen sind in einem Anwendungssystem gebündelt.
Die Funktionsintegration hat die Verzahnung betrieblich zusammengehöriger Funktionen als Ziel. So bieten beispielsweise Online-Shop-Systeme neben Bestellmöglichkeiten und Funktionen zur Warenwirtschaft oft auch Buchhaltungsfunktionen an.
...
![Anwendungsysteme mit nicht integrierten Daten fürhen zu Redundanzen](images/redundanzen.svg){#fig-redundanzen}
...
- Wenn die innerbetrieblichen Informationsflüsse und Funktionen optimal aufeinander abgestimmt sind, spricht man von `[...]` Integration.
- Wenn ein Unternehmen mit seinen Geschäftspartnern gemeinsame Datenbestände vereinbaren, standardisieren und über das Web austauschen, handelt es sich um `[...]` Integration.
- Bei `[...]` Integration stehen Informationsflüsse von unten nach oben und umgekehrt im Mittelpunkt.

## Integrationsdimensionen

Besprechen Sie in der Gruppe die **Vorteile** und **Herausforderungen** der integrierten Informationsverarbeitung.
...
Weshalb ist Integration für effizientes Informationsmanagement im Unternehmen wichtig? Finden Sie **jeweils min. ein Argument für die Relevanz von Daten-, Funktions- und Prozessintegration**.
...
Geben Sie ein Beispiel für zwei unterschiedliche Sichten auf dasselbe Stammdatenobjekt.

Worüber werden spezifische Stammdatensätze identifiziert (bspw. ein Kunde)?
...
- Beschreiben Sie Vor- und Nachteile eines zentralen Datenbanksystems.

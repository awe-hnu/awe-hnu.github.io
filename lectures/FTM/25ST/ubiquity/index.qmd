...
Take 10 minutes and identify the tasks and activities where you heavily rely on mobile computing and imagine what you would do if you would not have access to a smartphone.
...
## Exercise {background-color=#000}

Split-up into groups of 2-3, select on of the sectors listed below, take 30 minutes and work on following tasks:
...
## Reflection {background-color=#000}

Split-up into groups of 2-3, select on of the sectors listed below, take 20 minutes to discuss following questions:
...
- Would you personally want to use AR glasses as your primary computing device? Why or why not?

...
@raisch2021automation argue that automation and augmentation are *not* opposing strategies, but that they are **interdependent:**
...
:::fragment
:::medium
It is not about either augmentation or automation, but\ 
*"when, where, and how to combine both?"*
:::
:::
...
:::incremental
- Intelligence should be studied at the **group level** of humans and AI-machines working together and not at the level of individual components
- Increasing system intelligence means **increasing the quality of interaction** between components and not merely improving individual components
- Both human and artificial intelligence are shallow when considered in isolation
- **No AI is an island** which implies that value emerges from the system, not the artefact
:::

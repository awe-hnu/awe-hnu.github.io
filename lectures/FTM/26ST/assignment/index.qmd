...
- Clearly defines the chosen emerging technology (also based on the concepts discussed in class)
...
- Recommendation is to focus the search on high-quality IS journals^[For a more balanced discussion of quality indicators of papers see e.g., @fitzgerald2019information], such as [Senior Scholars' List of Premier Journals](https://aisnet.org/page/SeniorScholarListofPremierJournals) and/or A-ranked or B-ranked journals in the [VHB-JOURQUAL3 ranking](https://www.vhbonline.org/services/vhb-rating-2024)

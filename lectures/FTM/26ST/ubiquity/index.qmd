...
Identify at least one example, reflect the characteristics discussed and name the main technological enablers.
...
: Cloud-native deployment, edge computing, and over-the-air updates enable software to flow across distributed environments and is no longer bound to individual devices.
...
- Context: User carries context^[In mobile computing, the environment is unaware of the user; the context is located inside the user's mobile devic; and the continuity of interaction is manual/device-driven. In short: technology is still a distinct, bounded object that users must actively manage and carry through an *indifferent* physical world.]
...
:::medium
The smartphone represents a [transitional artifact]{.highlight}: too visible to be truly ubiquitous, yet nowadays too connected to be merely mobile.
:::

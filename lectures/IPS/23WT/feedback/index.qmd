...
# Feedback {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
[To help increase knowledge, skill, capability, growth *or* to raise feelings in the relationship.]{.fragment .fade-in-then-semi-out}
...
Challenging others and encouraging them to challenge you helps build trusting relationships because it shows 1) **you care** enough to point out both the things that aren’t going well and those that are and that 2) you are willing to admit when you are wrong and that **you are committed to fixing mistakes** that you or others have made. *@scott2019radical*

## Care for people  {.html-hidden .unlisted .vertical-center}
...
# Giving feedback {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
# Getting feedback {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}
...
[—emotional responses to feedback we feel is wrong, unhelpful, or unfair.]{.fragment .fade-in-then-semi-out}     

[Relationship triggers]{.fragment .fade-in-then-semi-out .large}     
[—emotional responses to the person giving the feedback more than the content of the feedback itself.]{.fragment .fade-in-then-semi-out}
...
[Also remember: to see ourselves and our blind spots we need help from others]{.fragment .fade-in}
:::
...
:::fragment
:::medium
Manage [switchtracking]{.fragment .highlight-current-blue} by [spotting the two topics]{.fragment .highlight-current-blue} and [discussing them separately]{.fragment .highlight-current-blue}. Also try to [step back to see the whole system[^system]]{.fragment .highlight-current-blue}
:::
:::
:::
...
# A radical candid workplace {.vertical-center background-color="#0333ff" background-image="../assets/bg.jpg"}

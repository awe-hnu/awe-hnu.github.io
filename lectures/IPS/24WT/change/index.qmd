...
# Direct the Rider {.headline-only background-color="#0333ff" background-image="../assets/bg.jpg"}
...
# Motivate the Elephant {.headline-only background-color="#0333ff" background-image="../assets/bg.jpg"}
...
# Shape the path {.headline-only background-color="#0333ff" background-image="../assets/bg.jpg"}
...
To get to know, what we mean with (recent) theoretical and empirical findings and to prepare for next class please read @dirks2001role ([download](../feedback/assets/DirksEtAl_2001_OrgSci_Trust-in-Organizations.pdf)) and take some notes on the main constructs and findings.

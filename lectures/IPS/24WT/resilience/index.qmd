...
# Resilience {.headline-only background-color="#0333ff" background-image="../assets/images/bg.jpg"}
...
# Emotional agility {.headline-only background-color="#0333ff" background-image="../assets/images/bg.jpg"}
...
:::medium
However, **beauty and fragility** often go hand in hand[^truthOfLiving].
:::
...
# Thoughts on emotion and behavior  {.headline-only background-color="#0333ff" background-image="../assets/images/bg.jpg"}
...
## Growth and freedom {background-color="#0333ff" background-image="../assets/images/bg.jpg"}

...
## Leading change {background-color=blue background-image="images/elephant.jpg"}
...
- Rentless focus on problems rather than solutions
...
In what (change) situations do you experience mental paralysis?

# Direct the Rider {.vertical-center background-color=blue background-image="images/elephant.jpg"}
...
## Follow the bright spots {.vertical-center background-color=blue background-image="images/elephant.jpg"}
...
- Sternin looked for very poor kids who are bigger and healthier than the typical child and analyzed what the mothers were doing differently (*posivite deviations*)
...
[^brightSpots]: Bright spots don’t have to be shining success stories, just look for siituations when things are working bether than others.

## Script the critical moves {.vertical-center background-color=blue background-image="images/elephant.jpg"}
...
## Point to the destination {.vertical-center background-color=blue background-image="images/elephant.jpg"}
...
Can you think of situations in life where we try to get people to change with information, rather than with feeling?

To be more effective, how might we approach those situations differently?

# Motivate the Elephant {.vertical-center background-color=blue background-image="images/elephant.jpg"}
...
## Find the feeling {.vertical-center background-color=blue background-image="images/elephant.jpg"}
...
## Shrink the change {.vertical-center background-color=blue background-image="images/elephant.jpg"}

> Break down the change until it no longer spooks the Elephant. *@heath2011switch*

----

### Example: Wass loyalty card
...
- Group B: Customers needed to collect ten stam, but they were given a "head start" (2 stamps have already been added)
...
## Grow your people {.vertical-center background-color=blue background-image="images/elephant.jpg"}
...
- Changing identities is a quest, an every quest involves failure. Because the Elephant hates failure, you should create the expectation of failure.
:::
...
:::{.incremental}
- It frames failure as a natural part of the change process (not of the situation) and
- A growth mindest helps to establish confidence that the Elephant is capable of conquering the change (he feels "big" relative to the challenge)
:::

# Reflect! {.unlisted .unnumbered .html-hidden .vertical-center background-color=black background-image="images/exercise.jpg"}

Think back over your day. In how many ways did your environment shape your behavior?

# Shape the path {.vertical-center background-color=blue background-image="images/elephant.jpg"}
...
## Tweak the environment {.vertical-center background-color=blue background-image="images/elephant.jpg"}
...
- Emphasize thee "tweak" (*focus on small changes*)
- Investigate your environment quickly (*What one thing can you shift to make the right behaviors
more likely?*)
...
## Build habits {.vertical-center background-color=blue background-image="images/elephant.jpg"}
...
## Rally the herd {.vertical-center background-color=blue background-image="images/elephant.jpg"}

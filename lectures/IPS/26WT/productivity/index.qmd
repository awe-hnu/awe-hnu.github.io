...
# Introduction {.headline-only background-image="../assets/bg.jpg"}
...
> Indistractable people are as honest with themselves as they are with others. *@eyal2019indistractable [p. 15]*
...
[&nequiv; important things]{.fragment .fade-in}
:::
:::
...
:::html-hidden
:::r-stack
![Traction and distraction [@eyal2019indistractable, p. 13]](images/distraction-action-1.svg){.fragment height="420"}

![Traction and distraction [@eyal2019indistractable, p. 13]](images/distraction-action-2.svg){.fragment height="420"}

![Traction and distraction [@eyal2019indistractable, p. 13]](images/distraction-action.svg){.fragment height="420"}
:::
:::
...
:::html-hidden
:::r-stack
![The Indistractable Model [@eyal2019indistractable, p. 17]](images/model-1.svg){.fragment height="420"}

![ ! ](images/model-2.svg){.fragment height="420"}

![ ! ](images/model-3.svg){.fragment height="420"}

![ ! ](images/model.svg){.fragment height="420"}
:::
:::
...
# Master Internal Triggers {.headline-only background-image="../assets/bg.jpg"}

## Problem

:::html-hidden
:::large
The pain of [wanting]{.fragment .highlight-blue}
:::
:::
...
:::fragment
:::large
We are motivated by [pleasure]{.link-color}.
:::
:::
:::
...
:::fragment
Thus, all motivation is a desire to **escape [discomfort.]{.fragment .strike}** 
:::

:::incremental
- If a behavior was previously effective at providing relief, we're likely to continue using it as a tool to escape 
discomfort.
...
###  Behavioral Loop of Pleasure-Seeking
...
Our tendencies toward **boredom**, **negativity bias**, **rumination**, and **hedonic adaptations** prevent us from 
ever being satisfied for long.

:::fragment
:::large
> If we want to master distraction, we must learn to deal with discomfort.  *@eyal2019indistractable [p. 33]*
:::
:::

:::fragment
Feeling bad is evolutionarily purposeful, exactly what survival of the fittest intended. It is an innate power that can
be channeled to help us make things better.
:::
...
:::large
Notice the urge and [ride it like a surfer riding a wave]{.link-color}, instead of giving in.
:::
...
:::large
[Use fun and play]{.link-color} in dreary task to keep you focused.
:::
...
# Fight External Triggers {.headline-only background-image="../assets/bg.jpg"}
...
:::html-hidden
:::large
[Discomfort (pain of wanting)]{.fragment .fade-in}   
[+ easy action to perform]{.fragment .fade-in}   
[+ trigger]{.fragment .fade-in .link-color}   
...
:::fragment
Email
: To get fewer emails, send fewer emails (e.g., respond at a scheduled time rather than immediately).
:::
...
# Make Time for Traction {.headline-only background-image="../assets/bg.jpg"}
...
[^timebox]: There are several tutorials available on how to use a calendaring tool for timeboxing, see e.g., [How to 
Block Time on Google Calendar](https://www.makeuseof.com/tag/block-time-google-calendar/).
...
# Prevent Distraction {.headline-only background-image="../assets/bg.jpg"}
...
:::html-hidden
:::large
[Removing a future choice]{.link-color} in order to overcome our impulsiveness
:::
:::
...
:::html-hidden
:::large
[Make unwanted behavior more difficult]{.link-color} to perform or add a cost to getting distracted.
:::
:::
...
:::notes
Research shows that an action (in this case, voting) that is presented as **an expression of the self**, a symbol of a person's fundamental character (e.g., being a voter), is more likely to be performed than if it is simply referred to as a behavior (e.g., to vote) [@bryan2011motivating].
...
- **Adopt rituals:** perform routines that reinforce your identity and influence your future actions (e.g., by 
  showing commitment to the group) [@hobson2018psychology]
...
# Homework {background-color=black}

To get to know, what we mean with (recent) theoretical and empirical findings and to prepare for our **feedback class** 
please read @dirks2001role ([download](../feedback/assets/DirksEtAl_2001_OrgSci_Trust-in-Organizations.pdf)) and take some notes on the main constructs and findings.

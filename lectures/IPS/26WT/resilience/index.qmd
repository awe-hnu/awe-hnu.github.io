...
| Section                                                            | Est. time    |
|--------------------------------------------------------------------|--------------|
| Opening hook (scenario, dilemma, inner-world quote)                | 5 min        |
| Reflection exercise (paired share) + debrief                       | 13 min       |
| Contents + Foundation                                              | 3 min        |
| Resilience research (Definition, themes, resources, optimism)      | 13 min       |
| Emotional agility warm-up + bad/good emotions + Bothness           | 8 min        |
| Susan David TED talk                                               | 12 min       |
| Magritte pipe + Growth/freedom quote + rigidity-vs-agility r-stack | 9 min        |
| Hooked + reflection exercise + debrief                             | 10 min       |
| Getting unhooked r-stack                                           | 13 min       |
| Sarah case discussion                                              | 10 min       |
| Closing + Challenges + reading list                                | 5 min        |
| **Total**                                                          | **~101 min** |
...
## The Inner World {.no-headline .vertical-center background-color="#f4f4f4"}
...
# Emotion and Behavior  {.headline-only background-image="../assets/images/bg.jpg"}
...
The first step is acknowledging emotions and stresses as they occur, to learn from them rather than dwell on them. What am I feeling right now? What does this say about my values? An emotionally agile person is able to recognize their feelings with self-compassion and understanding.
...
:::{.callout-note}
#### Characteristics of Values [@david2016emotional]
...
Emotional agility means aligning actions with values even when uncomfortable.
:::
...
:::fragment
Every system you build, every transformation you lead, exists in a human context. Your ability to remain emotionally agile separates effective leaders from those who burn out or stagnate.
...
:::incremental
- **Level 1:** *Reflect through writing.* During the next two weeks, take 10 minutes at the end of each day to write about your emotional experiences from the past day; don't worry about making it perfect or readable: go where your mind takes you: the goal is getting those thoughts out of your head and onto the page, not producing a keepable document (you can delete it).
...
- **Level 3:** *Getting unhooked.* extend *watch the gaps* and recognize your patterns, notice if you’ve been hooked by your thoughts and feelings; if so, label them, accept them, and then act on your values (i.e., take deliberate action that aligns with your values; embracing the challenge rather than reverting to familiar patterns, without becoming overwhelmed)
:::

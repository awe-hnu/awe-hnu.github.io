...
# Traction {.headline-only background-image="../assets/bg.jpg"}
...
# Distraction {.headline-only background-image="../assets/bg.jpg"}
...
To get to know, what we mean with (recent) theoretical and empirical findings and to prepare for our next class please read @dirks2001role ([download](../feedback/assets/DirksEtAl_2001_OrgSci_Trust-in-Organizations.pdf)) and take some notes on the main constructs and findings.

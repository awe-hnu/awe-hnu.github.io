...
As a re-examination task you will be required to work on a **business challenge** posed by practitioners. As last semester your will work **as a group** to
...
The detailed briefing of the challenge is documented in the section [Business challenge](#business-challenge) below.
...
You have 10 minutes for the presentation (date please see the [schedule](../admin/index.html#schedule))

...
**Four students form a group.**

:::incremental
- You can make an initial proposal for the group constellations until the deadline (see [schedule](../admin/index.qmd#schedule)).
...
:::fragment
Each group selects one of the **presented challenges** (deadline see [schedule](../admin/index.qmd#schedule)).
:::
...
:::incremental
- The **presentation** gets to the heart of your idea (40% of the grade):
  - Short summary of your concept (i.e., elevator pitch)
  - Presentation of the prototype of your design
- The **seminar paper** is a detailed documentation of your approach and of the artefact (60%):
...
- The paper should contain min. 3 pages of text per person, maximum 4 (details see template)

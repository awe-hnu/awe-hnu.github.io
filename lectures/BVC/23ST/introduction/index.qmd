...
- **IT-enabled resources** are systems that are formed through relationships between IT assets and organizational resources (e.g., IT-enabled CRM) [@wade2004resource]
:::
...
@piccoli2022digital defines some essential *digital* constructs as follows:
...
- **Digital resource** are a specific class of digital objects that are modular, encapsulate objects of value, and are accessible by way of a programmatic interface (e.g., Google Maps) involving
  - **Digital assets** are digital resources that encapsulate either nonmaterial digital objects, such as a catalog of digital songs, or hybrid digital objects, such as a virtualized computing resource
...
- Digital resources are accessed via a programmatic interface rather than a manual or physical interface.8 Access is fully managed by a software boundary that exposes the encapsulated asset or capability via a set of prespecified data elements and request-response actions.
:::

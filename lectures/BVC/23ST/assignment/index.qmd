...
The final teams^[Drop me a line if you want to change your team name] are:

:::: {.columns}
::: {.column}
__Unicorn Makers__ (A)

- Christian Gawlitza
- Christine Kuck
- Thi Yen Nga Nguyen

Challenge: BHW (home loan saving)

__Sprinterstellar__ (B)

- Akhila Ashok
- Ömer Kücükacar
- Mohammad Anees Raza

Challenge: Sparkasse (GPT powered roboadvisor)
:::
::: {.column}
__Epic Engineers__ (C)
...
Challenge: Gerresheimer (cancer home care)

__Trailblazers__ (D)

- Kishan Ajudiya
- Akhil Ashokbhai Dobariya
- Bilal Muhammad

...
During the semester you will be required to work on a **business challenge** posed by a partner of [EKIPA](https://ekipa.de/en/homepage/). As a **group**, you
...
The __business challenges__ will be presented by EPICA in our second session. 
...
There will be exactly __3 or 4 students in each group__.

:::{.incremental}
- You are free to form groups during the first session.
...
As a group, you will deliver a __final presentation__ and a __seminar paper__ (including the EKIPA submission template as an appendix)[^contrib].

:::{.incremental}
- The __presentation__ gets to the heart of your idea:
  - Short summary of your concept (ie elevator pitch)
  - Presentation of the prototype of your design
- The __seminar paper__ is a detailed documentation of your approach and of the artefact:
  ...
  - Details of the artefact that you have developed
  - Your implementation and value-realization plan
  - Lessons learnt, contributions and practical recommendations for action
:::

[^contrib]: For each deliverable except the EKIPA submission template, individual contributions must be indicated (list them in a table in the Appendix).


## Presentation

You have 15 minutes for the final presentation (date please see the [schedule](../admin/index.html#schedule))
...
:::{.incremental}
- Student demonstrates excellent understanding of the problem, the approach, the solution and/or the implementation plan.
...
- __Appendix__: Provides information that may help to gain an even better understanding of your solution. Also include the completed EKIPA submission form.
...
- The paper should contain min. 10 pages of text per person (without graphics)

...
- [feasible]{.link-color} (i.e. that it can be implemented today within 6 months).
:::
:::
...
# General remarks {.headline-only background-color="#0333ff"}
...
# Some guidelines {.headline-only background-color="#0333ff"}
...
# Grading {.headline-only background-color="#0333ff"}

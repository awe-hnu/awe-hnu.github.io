...
:::{.incremental}
- **Digital objects**: enduring, structured collections of elements, whose component parts include one or more bitstrings (e.g., a digital movie)
- **Digital resource**: a specific class of digital objects that are modular, encapsulate objects of value, and are accessible by way of a programmatic interface (e.g., Google Maps) involving
  - **Digital assets**: digital resources that encapsulate either non-material digital objects, such as a catalog of digital songs, or hybrid digital objects, such as a cloud computing resources
  - **Digital capabilities**: digital resources that encapsulate repeatable patterns of organizational actions, yielding a capacity to undertake activities (e.g., calculating a route)
:::

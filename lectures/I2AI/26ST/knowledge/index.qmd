...
format: 
  html:
    ...
    margin-header: | 
      ...
      [Exercises] (exercises.html){.btn .btn-primary target="blank"}
    format-links: false     
...
The **wumpus world** is an environment in which knowledge-based agents can show their worth^[A Wumpus World Simulator can be found here: [https://thiagodnf.github.io/wumpus-world-simulator/](https://thiagodnf.github.io/wumpus-world-simulator/)].
...
Analyze whether ChatGPT can be classified as a knowledge-based agent according to what you know by now.

...
::: chain-box
#### Facets of contemporary AI
Autonomy — acts without per-decision human instruction · Learning — behaviour changes over time · Inscrutability — internal logic is opaque to observers
:::
...
::: chain-box
#### AI-induced market and resource shifts
**Market:** narrow → pervasive · human-crafted → AI-driven · generalised → individual targeting  
**Resource:** manual → data-driven · uncertainty as unavoidable factor · AI-enhanced productivity
:::
...
::: chain-box
#### AI-related strategic challenges
**Scope** — organisational structures · **Scale** — technological resources · **Speed** — continuity vs opportunity · **Source** — business model impact
:::
...
::: chain-box
#### Strategic response — AI strategy
**Taxonomy** — framework of dimensions and characteristics · **Clusters** — typical strategic manifestations in practice
:::
: Figure 1: Chain of argumentation for the need for an AI strategy. Adapted from @urbach2026strategizing [p. 163]. {#fig-chain}
...
- **Strategic challenges:** new tensions across all four dimensions
  ...
  - *Source:* how AI affects the business model (e.g., technology apsiration, value creation)
...
::: incremental
1. Estabilishing an AI strategy with consideration of internal values
2. Setting up an AI roadmap
3. Identificaition and development of use cases
4. Iterative analysis and comparision with requirements
5. Ensuring sage AI usage 

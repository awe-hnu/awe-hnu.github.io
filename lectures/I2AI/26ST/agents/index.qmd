...
format:
  html:
    ...
    margin-header: |
      <a href="slides.html" class="btn btn-primary" target="blank">Slides</a>
      <a href="solutions/solutions.html" class="btn btn-secondary" target="blank">Solutions</a>
    format-links: false
...
## Task environments for Agentic AI
...
As announced last week, most of the lectures will be delivered using the flipped classroom approach.

Please prepare by looking at last week's class exercises, working through this week's class lecture notes independently, and noting down any issues you have understood. In class, we will clarify any questions you have and work on the exercises.
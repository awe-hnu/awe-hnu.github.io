...
:::notes
Map each component to the figure: state space = cities, initial state = Arad, goal state = Bucharest (goal test: is state Bucharest?), actions = road segments, costs = distances. Stress that this is a model, i.e., an abstraction that ignores weather, road quality, etc.
:::

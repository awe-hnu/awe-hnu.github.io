...
[Slides](I2AI_2_S.html){#fig-elephant}

# Agents {.vertical-center background-color=blue background-image="images/bg-circles.jpeg"}

## Agent

![Agents interact with environments through sensors and actuators](images/2/actor.svg){#fig-agent}
...
::: {.fragment}
> For each possible percept sequence, a rational agent should select an *action* that is expected to maximize its *performance measure*, given the evidence provided by the *percept sequence* and whatever built-in *knowledge* the agent has [@RusselNorvig2022AIMA, p.58].
:::
...
# Environments {.vertical-center background-color=blue background-image="images/bg-circles.jpeg"}
...
# Agent types {.vertical-center background-color=blue background-image="images/bg-circles.jpeg"}

## Simple reflex agents

![A simple reflex agent](images/2/simple-reflex-agent.svg){#fig-sr-agent}
...
![A model-based reflex agent](images/2/model-based-reflex-agent.svg){#fig-mr-agent}
...
![A model-based, goal-based agent](images/2/goal-based-agent.svg){#fig-gb-agent}
...
![A model-based, utility-based agent](images/2/utility-based-agent.svg){#fig-ub-agent}
...
There are also utility-based agents that are not model-based. These agents just learn what action is best in a parcitular situation without any "understanding" of its impact on the environment (e.g., based on reinforcement learning).
:::

## Learning agents

![A learning agent](images/2/learning-agent.svg){#fig-l-agent}

::: {.notes}
:::

# ✏️ Exercises {.vertical-center background-color=blue background-image="images/bg-circles.jpeg"}

...
Take 20 minutes to read the article, to think about the following questions and to prepare answers.

- Do you think that AI is rather an elevator or a king-maker? Why?
...
Take 20 minutes, think about the following questions and prepare answers.
...
Form groups of two, take 20 minutes to revisit the case study and work on following questions.
...
Let's do some research to learn more about government and private sector-driven approaches to moving toward responsible AI.

## European Union {background-color="black"}

Take 25 minutes to research about the __Artificial Intelligence Act__ of the European Union.
...
Prepare a short presentation (approx 5 minutes).

## Microsoft  {background-color="black"}

Research about __Microsoft Responsible AI Standard__ (v2)

Take 25 minutes to understand the goals of this standard and the principles applied.

Also consider how Microsoft propose to assess the impact of AI and how the standard affects Microsofts own operations and services.
...
Research about [Googles AI principles](https://ai.google/responsibility).

Take 25 minutes to understand and to assess Googles principles. Create a short summary of your learnings, also tackling following questions:.

...
# Decisions under uncertainty  {.vertical-center background-color="#564ac6" background-image="../assets/bg.jpeg"}
...
Conditional probabilities (or posterior probabilities) are defined in terms of unconditional probalities as follows:
...
# Bayes' rule {.vertical-center background-color="#0333ff" background-image="images/bg.jpeg"}
...
# Naive Bayes models {.vertical-center background-color="#564ac6" background-image="../assets/bg.jpeg"}
...
$$
\begin{flalign}
P(a|b \land a) = \frac{P(a \land b)}{P(a \land b)} = 1 &&
\end{flalign}
$$

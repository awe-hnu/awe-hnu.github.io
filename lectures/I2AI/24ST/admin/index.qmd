...
You will prepare the contents for each lecture on your own, using the lecture notes and reading material provided (i.e., references). It is thus necessary, to be prepared for each session (see @tbl-schedule).
...
| `16.05.2024` | Guest speech: Reality of AI/ML in Industry^[Thursday for once!]         | -
| `03.06.2024` | Ethics                                             | Case Study

...
::: {.incremental}
- They know what actions are available ($\textrm{ACTIONS}(s)$) and what the result of performing a specific action from a specific state will be ($\textrm{RESULT}(s,a)$). But they **don't know general facts**.

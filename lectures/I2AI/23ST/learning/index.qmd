...
## Discussion {.html-hidden .discussion-slide .unlisted background-color="#0333ff"}
...
# The learning agent {.vertical-center background-color="#564ac6" background-image="../assets/bg.jpeg"}
...
# Decision trees {.vertical-center background-color="#564ac6" background-image="../assets/bg.jpeg"}
...
# Statistical ML {.vertical-center background-color="#564ac6" background-image="../assets/bg.jpeg"}
...
$$
\begin{flalign}
P(h_i|d) = P(d|h_i)P(h_i) \approx P(d|h_{MAP})
\end{flalign}
$$
...
# Deep learning {.vertical-center background-color="#564ac6" background-image="../assets/bg.jpeg"}
...
# Development process {.vertical-center background-color="#564ac6" background-image="../assets/bg.jpeg"}
...
1. Assuming no smoothing, given estimates for the parameters of the classification rule based on the training samples.
2. Suppose a subject which has stripe but not spot or blue eyes. What would happen if the robot had to guess the identity of the subject?

...
- In three of these models $R_1$ through $R_5$ are true
- In all three rows, $P_{1,2} is false
...
# Propositional proofs {.vertical-center background-color=blue background-image="images/bg.jpeg"}

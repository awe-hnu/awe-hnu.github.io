...
# Working in complex environments {.headline-only}

## Agents

:::medium
An agent is anything that can be viewed as perceiving its [environment]{.fragment .custom .bold} through [sensors]{.fragment .custom .bold} and acting upon that environment through [actuators.]{.fragment .custom .bold}
:::
...
Take 10 minutes for this exercise and prepare yourself to present your findings.
...
Processing mental information requires **attention**, **memory**, **perception**, **reasoning**, and **executive functions**.

. . .

@Molina2020Intelligent discusses four types of cognitive abilities that AI systems need to implement: 

:::medium
[perception[^Pe],]{.fragment}\
[deliberation[^De],]{.fragment}\
[interaction[^In],]{.fragment}\
[action control[^Ac]]{.fragment}
:::

[^Pe]: Perception refers to AI systems' ability to gather and interpret data from their environment through sensors, cameras, microphones, or data inputs

[^De]: Deliberation refers to the computational processes of analyzing information, drawing conclusions, and making decisions.

[^In]: Interaction refers to the communication capabilities with AI systems, including natural language processing and generation.

[^Ac]: Action control refers to the mechanisms that translate decisions into actions or outputs in the environment.

### Primary cognitive abilities

:::r-stack

![Primary cognitive abilities of intelligent systems based on @Molina2020Intelligent](images/cognition-1.svg){.fragment 
height="400"}
...
:::medium
Describe the basic cognitive abilities of an [autonomous car]{.link-color} or a [chatbot]{.link-color} and how they are 
technically 
implemented.
:::

Form small groups, take 7 minutes for this exercise. \
...
- What goals/objectives do they have?
...
:::large
Under which circumstances does a [vacuum cleaning agent]{.link-color} act rational?
:::

...
:::medium
The protocols are based on the principles of [independency]{.highlight}^[Independency refers to the fact that there are no specific hardware and software requirements] and [robustness]{.highlight}^[Refers to the a built in failure recovery mechanism that provides reliable end to end communication].
:::
...
Research what [Content Delivery Networks (CDN)]{.highlight} are and why they gained increasing importance in recent years.
...
2. How does increased interconnectedness in CDNs create both resilience and new vulnerabilities? What happens when one node fails versus when the coordination mechanism fails?
...
:::large
The net neutrality movement aims to keep the internet [free and open]{.highlight}.
:::
...
:::medium
The internet as it is today^[The internet as of today is often termed Web 2.0] is increasingly dominated by a few large platforms^[Dominant internet players are the large platforms for e.g., social media, marketplaces, and CDN] and cloud service providers^[The internet big five, also known as GAFAM, are Google, Amazon, Meta (formerly Facebook), Apple, and Microsoft] — [counteracting the original decentralized nature of the internet]{.highlight}.
:::

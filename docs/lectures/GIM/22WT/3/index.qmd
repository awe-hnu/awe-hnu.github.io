...
Recherchieren Sie auf der Website von [Microsoft Azure](https://azure.microsoft.com) je **Servicemodell** (IaaS, PaaS, SaaS) ein konkretes Angebot und beschreiben Sie dieses in Ihren eigenen Worten.

## Cloud-Computing Vor- & Nachteile

Diskutieren Sie die **Vor- und Nachteile** des Cloud-Computings und fassen Sie Ihre Ergebnisse in einer Tabelle zusammen.
